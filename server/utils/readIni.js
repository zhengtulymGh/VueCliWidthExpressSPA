...
exports.readIni = function(fileName/*,charset*/){
  var ret = {};
  var obj = exports.parse(fs.readFileSync(fileName, "utf-8"));
  for(const k in obj) {
    if (typeof obj[k] === 'function') continue;
    if (k === 'sections' && obj.sections) {
      for (const i in obj.sections) {
        ret[i] = obj.sections[i];
      }
    } else {
      ret[k] = obj[k];
    }
